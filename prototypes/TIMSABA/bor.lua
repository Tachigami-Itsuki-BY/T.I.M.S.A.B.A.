...
({
    {
        ...
        name = borax,
        subgroup = is_bor,
        icon = "__TIMSABA__/graphics/icons/angels/metallurgy/bor/item/borax.png",
        order = a,
        stack_size = 200,
        weight = 500
    }
...
({
    {
        ...
        name = boric_acid,
        subgroup = is_bor,
        icon = "__TIMSABA__/graphics/icons/angels/metallurgy/bor/fluid/boric-acid-solution.png",
        order = b,
    ...
    },
    {
        ...
        name = diborane_gas,
        subgroup = is_bor,
        icon = "__TIMSABA__/graphics/icons/angels/metallurgy/bor/fluid/diborane-gas.png",
        order = c,
        default_temperature = 0,
        heat_capacity = "0.1kJ",
