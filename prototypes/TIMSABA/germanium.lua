...
{
    {name = is_germanium,           order = f},
    {name = is_germanium_chemistry, order = f_a},
    {name = is_germanium_casting,   order = f_b}
})
...
({
    ...
    },
    {
        ...
        order = c,
        energy_required = 8, -- 3Ge(s) + 4HNO₃(l) + 12HCl(sq) --> 3GeCl₄(l) + 4NO(g) + 8H₂O(l)
        ingredients =
        {
    ...
    },
    {
        ...
        order = e,
        -- Na₂GeO₃(aq) + 6HCl(g) --> Na₂GeCl₆(s) + 4H₂O(g)
        ingredients =
        {
