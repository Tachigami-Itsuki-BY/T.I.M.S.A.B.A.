if settings.startup[setting_flow_control_new].value then
    ...
    {
        {name = stone_pipe,              folder_name = "stone",              order = c, inventory_move = item_sounds.brick_inventory_move, inventory_pickup = item_sounds.brick_inventory_pickup},
        {name = ceramic_pipe,            folder_name = "ceramic",            order = i, inventory_move = item_sounds.brick_inventory_move, inventory_pickup = item_sounds.brick_inventory_pickup},
        {name = nitinol_pipe,            folder_name = "nitinol",            order = k},
        {name = molybdenum_rhenium_pipe, folder_name = "molybdenum-rhenium", order = m},
    }
    ...
    local icons_pipe =
    {
        {base_name = stone_pipe,              tier = 1},
        {base_name = ceramic_pipe,            tier = 4},
        {base_name = nitinol_pipe,            tier = 5},
        {base_name = molybdenum_rhenium_pipe, tier = 6}
    }
