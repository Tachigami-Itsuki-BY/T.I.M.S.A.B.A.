...
data_active_defense_equipment = data.raw["active-defense-equipment"]
...
data_movement_bonus_equipment = data.raw["movement-bonus-equipment"]
...
data_solar_panel_equipment = data.raw["solar-panel-equipment"]
data_generator_equipment = data.raw["generator-equipment"]
data_roboport_equipment = data.raw["roboport-equipment"]
data_battery_equipment = data.raw["battery-equipment"]
data_movement_bonus_equipment = data.raw["movement-bonus-equipment"]
data_night_vision_equipment = data.raw["night-vision-equipment"]
data_belt_immunity_equipment = data.raw["belt-immunity-equipment"]
data_energy_shield_equipment = data.raw["energy-shield-equipment"]
data_active_defense_equipment = data.raw["active-defense-equipment"]
...
angels_sintering_1 = "angels-sintering-1"
...
b = "b" b_a = "b-a" b_b = "b-b" b_c = "b-c" b_d = "b-d" b_e = "b-e" b_f = "b-f" b_g = "b-g" b_h = "b-h" b_i = "b-i" b_j = "b-j" b_k = "b-k" b_l = "b-l" b_m = "b-m" b_n = "b-n"
c = "c" c_a = "c-a" c_b = "c-b" c_c = "c-c" c_d = "c-d" c_e = "c-e" c_f = "c-f" c_g = "c-g" c_h = "c-h" c_i = "c-i" c_j = "c-j" c_k = "c-k" c_l = "c-l" c_m = "c-m"
...
g = "g" g_a = "g-a" g_b = "g-b" g_c = "g-c" g_d = "g-d" g_e = "g-e" g_f = "g-f" g_g = "g-g" g_h = "g-h" g_i = "g-i" g_j = "g-j" g_k = "g-k" g_l = "g-l" g_m = "g-m"
h = "h" h_a = "h-a" h_b = "h-b" h_c = "h-c" h_d = "h-d" h_e = "h-e" h_f = "h-f" h_g = "h-g"
i = "i" i_a = "i-a" i_b = "i-b" i_c = "i-c" i_d = "i-d" i_e = "i-e" i_f = "i-f" i_g = "i-g"
j = "j" j_a = "j-a" j_b = "j-b" j_c = "j-c" j_d = "j-d" j_e = "j-e" j_f = "j-f" j_g = "j-g"
...
x = "x" x_a = "x-a" x_b = "x-b" x_c = "x-c" x_d = "x-d" x_e = "x-e" x_f = "x-f" x_g = "x-g"
...
_NF3_ = "__TIMSABA__/graphics/icons/fluid/NF3.png"
--_NHH_ = "__TIMSABA__/graphics/icons/fluid/NHH.png"
