...
({
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- C₆H₆(l) + HNO₃(l) -H₂SO₄-> C₆H₅NO₂(l) + H₂O(l)
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- C₆H₅NO₂(l) + 3H₂(g) -cat(Ni/Pd)-> C₆H₇N(l) + 2H₂O(l)
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- Na₂CO₃(aq) + NO(g) + NO₂(g) --> 2NaNO₂(s) + CO₂(g) + H₂O(l)
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- C₆H₇N(l) + NaNO₂(s) + 2HCl(aq) --> C₆H₅N₂Cl(aq) + NaCl(aq) + 2H₂O(l)
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- C₂H₄O(l) + HCN(l) + H₂O(l) --> C₃H₆O₃(l) + NH₃(g)
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- C₃H₆O₃(l) + C₂H₅OH(l) --> C₅H₁₀O₃(l) + H₂O(l)
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- Liquid Plastic + C₆H₅N₂Cl(aq) + C₅H₁₀O₃(l) --> Photoresist liquid
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = true,
        allow_decomposition = false,
        energy_required = 4, -- Plastic + Germanium plate + Antimony plate + Platinum wire + Photoresist liquid --> Semiconductor
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = true,
        allow_decomposition = false,
        energy_required = 4, -- LDS + Gallium arsenide + Gallium nitride + Niobium-titanium wire + Photoresist --> Semiconductor T2
        ingredients =
        {
...
({
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- C₂H₅Cl(g) + NaOH(aq) --> C₂H₅OH(l) + NaCl(aq)
        ingredients =
        {
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- C₂H₅OH(l) -cat(Cu/Ag)-> C₂H₄O(l) + H₂(g)
        ingredients =
        {
            {type = fluid, name = ethanol_angels, amount = 60},
            {type = item, name = catalyst_green, amount = 1}
    ...
    },
    {
        ...
        allow_quality = false,
        allow_decomposition = false,
        energy_required = 4, -- 2CH₄(g) + 2NH₃(g) + 3O₂(g) --> 2HCN + 6H₂O
        ingredients =
        {
