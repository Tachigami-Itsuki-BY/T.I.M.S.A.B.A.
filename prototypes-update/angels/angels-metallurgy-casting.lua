...
data_recipe[lead_plate_bob].localised_name = {"recipe-name.lead-plate"}
...
data_recipe[tin_plate_bob].localised_name = {"recipe-name.tin-plate"}
...
data_recipe[silicon_mono_2].results[2].probability = 0.75
...
data_recipe[solder_molten_angels].localised_name = {"recipe-name.molten-solder-angels"}
