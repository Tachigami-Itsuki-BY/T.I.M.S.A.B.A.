...
data_recipe[pentapod_egg].icons = THREE_D_I(pentapod_egg, nutrients, water, pentapod_egg, nil, nil, number_1)
...
data_recipe[rocket_fuel_from_jelly].icons = THREE_D_I(jelly, bioflux, water, rocket_fuel)
...
data_recipe[agricultural_tower].ingredients[1].name = cobalt_steel_plate_bob
...
data_recipe[capture_robot_rocket].ingredients[2].name = cobalt_steel_plate_bob
...
data_recipe[rocket_turret].ingredients[4].name = cobalt_steel_plate_bob
data_recipe[rocket_turret].ingredients[4].amount = 16
data_recipe[rocket_turret].ingredients[5].name = cobalt_steel_gear_wheel
